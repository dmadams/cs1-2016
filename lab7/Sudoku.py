            ...
            for i in range(3):
                for j in range(3):
                    if val == self.board[i][j]:
                        raise SudokuMoveError('There is a already a %d in ' \
                                              'this box.' %val)
        if 1 <= row <= 3 and 4 <= col <= 6:
            for i in range(3):
                for j in range(3, 6):
                    if val == self.board[i][j]:
                        raise SudokuMoveError('There is a already a %d in ' \
                                              'this box.' %val)
        if 1 <= row <= 3 and 7 <= col <= 9:
            for i in range(3):
                for j in range(6, 9):
                    if val == self.board[i][j]:
                        raise SudokuMoveError('There is a already a %d in ' \
                                              'this box.' %val)
        if 4 <= row <= 6 and 1 <= col <= 3:
            for i in range(3, 6):
                for j in range(3):
                    if val == self.board[i][j]:
                        raise SudokuMoveError('There is a already a %d in ' \
            ...
            for i in range(3, 6):
                for j in range(3, 6):
                    if val == self.board[i][j]:
                        raise SudokuMoveError('There is a already a %d in ' \
                                              'this box.' %val)
        if 4 <= row <= 6 and 7 <= col <= 9:
            for i in range(3, 6):
                for j in range(6, 9):
                    if val == self.board[i][j]:
                        raise SudokuMoveError('There is a already a %d in ' \
                                              'this box.' %val)
        if 7 <= row <= 9 and 1 <= col <= 3:
            for i in range(6, 9):
                for j in range(3):
                    if val == self.board[i][j]:
                        raise SudokuMoveError('There is a already a %d in ' \
                                              'this box.' %val)
        if 7 <= row <= 9 and 4 <= col <= 6:
            for i in range(6, 9):
                for j in range(3, 6):
                    if val == self.board[i][j]:
                        raise SudokuMoveError('There is a already a %d in ' \
                                              'this box.' %val)
        if 7 <= row <= 9 and 7 <= col <= 9:        
            for i in range(6, 9):
                for j in range(6, 9):
                    if val == self.board[i][j]:
                        raise SudokuMoveError('There is a already a %d in ' \
